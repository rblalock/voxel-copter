...
import type debriefAgent from '../agent/debrief/index.js';
import type missionAgent from '../agent/mission/index.js';
...
/**
 * Input type for route: POST /api/mission/debrief
 */
export type POSTApiMissionDebriefInput = InferInput<typeof debriefAgent['inputSchema']>;

/**
 * Output type for route: POST /api/mission/debrief
 */
export type POSTApiMissionDebriefOutput = InferOutput<typeof debriefAgent['outputSchema']>;

/**
 * Input schema type for route: POST /api/mission/debrief
 */
export type POSTApiMissionDebriefInputSchema = typeof debriefAgent extends { inputSchema?: infer I } ? I : never;

/**
 * Output schema type for route: POST /api/mission/debrief
 */
export type POSTApiMissionDebriefOutputSchema = typeof debriefAgent extends { outputSchema?: infer O } ? O : never;

/**
 * Input type for route: POST /api/mission/generate
 */
export type POSTApiMissionGenerateInput = InferInput<typeof missionAgent['inputSchema']>;

/**
 * Output type for route: POST /api/mission/generate
 */
export type POSTApiMissionGenerateOutput = InferOutput<typeof missionAgent['outputSchema']>;

/**
 * Input schema type for route: POST /api/mission/generate
 */
export type POSTApiMissionGenerateInputSchema = typeof missionAgent extends { inputSchema?: infer I } ? I : never;

/**
 * Output schema type for route: POST /api/mission/generate
 */
export type POSTApiMissionGenerateOutputSchema = typeof missionAgent extends { outputSchema?: infer O } ? O : never;
...
declare module '@agentuity/frontend' {
	...
	'POST /api/mission/debrief': {
				inputSchema: POSTApiMissionDebriefInputSchema;
				outputSchema: POSTApiMissionDebriefOutputSchema;
				stream: typeof debriefAgent extends { stream?: infer S } ? S : false;
				params: never;
			};
	'POST /api/mission/generate': {
				inputSchema: POSTApiMissionGenerateInputSchema;
				outputSchema: POSTApiMissionGenerateOutputSchema;
				stream: typeof missionAgent extends { stream?: infer S } ? S : false;
				params: never;
			};
	'GET /api/stats': {
				inputSchema: never;
	...
	export interface RPCRouteRegistry {
		mission: {
			debrief: {
				/**
				 * Route: POST /api/mission/debrief
				 */
				post: { input: POSTApiMissionDebriefInput; output: POSTApiMissionDebriefOutput; type: 'api'; params: never; paramsTuple: [] };
			};
			generate: {
				/**
				 * Route: POST /api/mission/generate
				 */
				post: { input: POSTApiMissionGenerateInput; output: POSTApiMissionGenerateOutput; type: 'api'; params: never; paramsTuple: [] };
			};
		};
		stats: {
			event: {
				/**
				 * Route: POST /api/stats/event
				 */
...
const _rpcRouteMetadata = {
		"mission": {
				"debrief": {
						"post": {
								"type": "api",
								"path": "/api/mission/debrief"
						}
				},
				"generate": {
						"post": {
								"type": "api",
								"path": "/api/mission/generate"
						}
				}
		},
		"stats": {
